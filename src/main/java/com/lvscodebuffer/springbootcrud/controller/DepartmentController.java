package com.lvscodebuffer.springbootcrud.controller;
...
import com.lvscodebuffer.springbootcrud.entity.mappers.MapstructMapper;
import com.lvscodebuffer.springbootcrud.repository.DepartmentRepository;
import com.lvscodebuffer.springbootcrud.service.DepartmentService;
...
public class DepartmentController {
    ...
    public Department updateDepartment(@PathVariable("id") Long departmentId, @RequestBody UpdateDepartmentDto department){
